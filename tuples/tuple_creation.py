...
#you can have variable representing a tuple inside another tuple
air_force = ("f15","f22a","f35a")
fighter_jets = (1988,2005,2016,air_force)
print(fighter_jets)

#A comma should be added at the end of a tuple with one item
singleton = ("hello",)
print(type(singleton))

#When adding one item to an empty tuple put a comma at the end.
list_2 = ["Kenya"]
print(singleton)
